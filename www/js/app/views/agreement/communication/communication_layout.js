define(['backbone', 'handlebars', 'hbs!templates/agreement/communication/communication_layout', 'underscore', 'marionette',
    ...
    function(Backbone, Handlebars, tpl, _, Marionette, MessagesLayout, NewMessages) {
        ...
        var Layout = Backbone.Marionette.Layout.extend({
            ...
            onRender: function() {
                this.messagesSection.show(new MessagesLayout({
                    tags: this.tags,
                    messages: this.messages,
                    user: this.user,
                    otherUser: this.otherUser
                }));
                var lastMessage = this.messages.at(this.messages.length - 1);
                var messageTags = (lastMessage) ? lastMessage.get("tags").toJSON() : null;
                var newMessagesView = new NewMessages({
                    tags: this.tags,
